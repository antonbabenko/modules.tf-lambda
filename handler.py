...
def handler(event, context):
    ...
    if not request_from_lb:
        logger.error(f"Got event not from ALB: {event}")
        raise NotImplementedError("An event came not from ALB and cannot be served")
